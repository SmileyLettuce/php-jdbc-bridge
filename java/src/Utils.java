...
public class Utils {
    ...
    public static String formatSQLErrorMessage(SQLException e){

        String errorCode = String.valueOf(e.getErrorCode()).isEmpty() ? "" : e.getErrorCode() + " ";
        String sqlState = e.getSQLState().isEmpty() ? "" : "(" + e.getSQLState() + ")";
        String msg = e.getMessage();

        return "ERROR " + errorCode + sqlState + ": " + msg;
    }
